...
exports.orderRes = async (name,price,image,quantity,type,email,nameuser,address,phone)=>{
    
    //const hash = await bcrypt.hash(password,await bcrypt.genSalt(10));
    order = await orderService.order(name,price,image,quantity,type,email,nameuser,address,phone);
